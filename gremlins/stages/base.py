...
class Stage:
    ...
    def substitute_vars(
        self, text: str, gremlin: State, extra: dict[str, str] | None = None
    ) -> str:
        ...
        subs = {**string_opts, **(extra or {}), **gremlin.framework_subs(self)}  # type: ignore[arg-type]
    ...
    async def run(self, gremlin: State) -> Outcome:  # noqa: ARG002
