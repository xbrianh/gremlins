...
- **Other blocker-severity findings** (correctness, design, or anything a human should weigh in on): run `python -m gremlins.bail reviewer_requested_changes "<one-line summary>"`
