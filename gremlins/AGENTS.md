...
- `stages/` — per-stage bodies: `plan`, `implement`, `review_code`, `address_code`, `verify`, `test`, `ghreview`, `ghaddress`, `github_request_copilot_review`, `wait_copilot`, `wait_ci`, `handoff`.
