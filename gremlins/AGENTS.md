...
- `stages/` — per-stage bodies: `plan`, `review_code`, `github_address_pull_request_reviews`, `verify`, `github_request_copilot_review`, `github_wait_copilot`, `github_wait_ci`, `handoff`.
