<!-- placeholders: artifact_dir, instructions -->
Create a detailed implementation plan for the following task and write it to the file `{artifact_dir}/plan.md`. Use this structure:
