...
Print findings as markdown. For each issue, include the file path and line number. Keep the overall summary to 2–4 sentences. If there are no issues worth noting, say so explicitly.
